...
<html>
  <head>
      <title>Modification sur l'Atelier</title>
  ...
  <body>
    <div id="d">
      <br>
      <br>
    <h3 align="center">Modification de l'Atelier</h3><br><br><br><br>
    <p id="i"><img src="img/cnrs.gif" alt="cnrs"></p>
    <p id="j"><img src="img/fete.jpg" alt="fete"></p>

    
    <form name="form" action="/modifier-atelier">
      ...
      <tr>
        ...
        <tr>
          <td><b>Duree de l'atelier :</b></td><td><input type="text" name="duree"  value="30 min" /><td>
        </tr>
